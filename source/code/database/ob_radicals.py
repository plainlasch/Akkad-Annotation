"""Old-Babylonian Radical annotation"""
...
RADICAL_COUNTS_FILE = "dictionary/ob_radical_counts.json"
...
class AnnotatorApp:
    def __init__(self, root):
        ...
        # UI Setup
        self.label = tk.Label(root, text="Annotate the Radical Counts for Old-Babylonian Cursive", font=("Arial", 24))
        self.label.pack(pady=20)

        self.cuneiform_label = tk.Label(root, text=lookup_dict[self.current_sign], font=("Santakku", 60))
